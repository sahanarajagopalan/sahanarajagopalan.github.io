...
Large Language Models — transformers, embeddings, and how to use LLMs to build practical tools like assistants and recommender systems.

Core data science skills — model tuning, evaluation metrics, feature engineering, and end-to-end ML workflows.
